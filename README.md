...
In `0.10.0` the `environment` value is back to being an object instead of an array. Any settings that require pulling from a secret, downward api, etc should be set in `advancedEnvironment`.
...
| env.DATABASE_ROOT_USERNAME      | string | `""`                                                                                                 |                                                                                                                                   |
| env.DATABASE_USERNAME           | string | `""`                                                                                                 |                                                                                                                                   |
| env.FUSIONAUTH_APP_MEMORY       | string | `"256M"`                                                                                             |                                                                                                                                   |
| env.FUSIONAUTH_APP_RUNTIME_MODE | string | `"development"`                                                                                      |                                                                                                                                   |
| env.SEARCH_TYPE                 | string | `"elasticsearch"`                                                                                    |                                                                                                                                   |
| extraEnv                        | list   | `[]`                                                                                                 |                                                                                                                                   |
...
| search.host                     | string | `""`                                                                                                 | Hostname or ip to use when connecting to elasticsearch. Ignored when env.SEARCH_TYPE is NOT elasticsearch                         |
| search.port                     | int    | `9200`                                                                                               | Port to use when connecting to elasticsearch. Ignored when env.SEARCH_TYPE is NOT elasticsearch                                   |
| search.protocol                 | string | `"http"`                                                                                             | Protocol to use when connecting to elasticsearch. Ignored when env.SEARCH_TYPE is NOT elasticsearch                               |
