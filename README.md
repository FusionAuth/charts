...
| livenessProbe           | object | `{"failureThreshold":3,"httpGet":{"path":"/api/status","port":"http"},"periodSeconds":30}`  | Configures a livenessProbe to ensure fusionauth is running                                                                        |
...
| readinessProbe          | object | `{"failureThreshold":3,"httpGet":{"path":"/api/status","port":"http"}}`                     | Configures a readinessProbe to ensure fusionauth is ready for requests                                                            |
...
| startupProbe            | object | `{"failureThreshold":20,"httpGet":{"path":"/api/status","port":"http"},"periodSeconds":10}` | Configures a startupProbe to ensure fusionauth has finished starting up                                                           |
